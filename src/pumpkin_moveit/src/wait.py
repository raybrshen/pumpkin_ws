...
#     roscpp_initialize(sys.argv)
    ...
    for i in xrange(points):
        ...
        wpose.orientation.w = waypoints[i-1].orientation.w + 0.2
        wpose.orientation.x = waypoints[i-1].orientation.x - 0.40300994
        wpose.orientation.y = waypoints[i-1].orientation.y + 0.2
        wpose.orientation.z = waypoints[i-1].orientation.z - 0.40271365
