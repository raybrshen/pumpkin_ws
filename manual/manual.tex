...
Before running this node correctly, it is needed to pass to the node the path of the pumpkin package folder. To do that, there is two options: by environment variable, or by ROS parameter.
